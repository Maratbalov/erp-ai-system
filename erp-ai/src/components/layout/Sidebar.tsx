...
function SidebarContent() {
  return (
    <div className="flex flex-col h-full">
      {/* Logo */}
      <div className="flex items-center h-14 px-4 bg-primary-600">
        <h1 className="text-lg font-bold text-white">ERP AI</h1>
      </div>
...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  return (
    <>
      ...
      <Transition.Root show={isOpen} as={Fragment}>
        <Dialog as="div" className="relative z-40 md:hidden" onClose={onClose}>
          ...
          <div className="fixed inset-0 flex z-40">
            ...
            >
              <Dialog.Panel className="sidebar relative flex-1 flex flex-col max-w-xs w-full bg-white dark:bg-gray-800">
                <Transition.Child
                  as={Fragment}
      ...
      {/* Desktop sidebar */}
      <div className="sidebar hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
